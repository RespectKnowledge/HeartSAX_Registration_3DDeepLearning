# -*- coding: utf-8 -*-
"""
Created on Tue Jul 11 06:51:17 2023
...
save_dir = 'TransMorph_ncc_{}_dsc224{}_diffusion_{}/'.format(weights[0], weights[1], weights[2])
if not os.path.exists('experiments1/'+save_dir):
    os.makedirs('experiments1/'+save_dir)
...
reg_model.cuda()
reg_model_bilin = register_model(config.img_size, 'bilinear')
...
for epoch in range(epoch_start, max_epoch):
    ...
    for data in train_loader:
        ...
        #print()
        output1 = model(x_in)
        def_out = reg_model([x_seg.cuda().float(), output1[1].cuda()])
        def_segs = []
        for i in range(4):
    ...
    }, save_dir='experiments1/'+save_dir, filename='dsc{:.4f}.pth.tar'.format(eval_dsc.avg))
